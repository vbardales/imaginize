...
use Etf1\ImaginizeBundle\Model\CommentPeer;
...
abstract class BaseCommentQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'imaginize', $modelName = 'Etf1\\ImaginizeBundle\\Model\\Comment', $modelAlias = null)
	{
	...
	{
		$sql = 'SELECT `ID`, `VALUE` FROM `comment` WHERE `ID` = :p0';
		try {
